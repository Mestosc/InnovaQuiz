...
function mostrarPregunta() {
  ...
  selrespuesta.addEventListener("change", function () {
    ...
    let comparacionRespuesta = p.compararRespuesta(respuestaUsuario)
    let texto = comparacionRespuesta ? "Correcto, la respuesta es correcta" : "Incorrecto, la respuesta no es correcta";
