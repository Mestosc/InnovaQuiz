...
** Imagen de la pantalla de redencion
...
Aqui definimos los elementos que seran necesarios tener para luego poder llevar a cabo el flujo de ejecucion y que todo se vea correctamente a nivel global
#+begin_src javascript :exports code
...
** Fuente tipografica 
La fuente tipografica en general
#+begin_SRC css
...
#+end_SRC
** Cuerpo
Aqui defino un estilo especifico para el cuerpo del HTML que hace que se vea con ese degradado tan chulo
#+begin_src css
body {
...
#+end_src
** Select
El estilo que tiene el select que nos muestra las preguntas
#+begin_src css
#opciones select {
  appearance: none;
...
#+end_src
Aqui no voy a pararme a explicar todos y cada uno de los estilos quiero que se vea un poco la linea en general
** Estilos diversos
Aqui esta el estilo de los puntos y de los párrafos en general
#+begin_src css
#puntos {
  font-weight: bold;
  font-size: 1.5rem;
...
#+end_src
* Final ❓
Muchas gracias por vuestro tiempo espero que os haya gustado, esta presentacion fue hecha gracias a [[https://revealjs.com/][RevealJS]]
